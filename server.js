...
let databaseConnectionString = `mongodb://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@`;
...
mongoose.connect(databaseConnectionString, dbOptions);
...
// parts routes
require("./routes/Parts.js")(app, passport);

// toolkits routes
require("./routes/Toolkits.js")(app, passport);
